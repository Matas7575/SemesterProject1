...
public class AllCoursesList
{
  ...
  public Course getCourse(int semester, String classxyz, String title)
  {
    ...
    {
      int localSemester = allCourses.get(i).getSemester();
      String localClass = allCourses.get(i).getClassxyz();
      String localTitle = allCourses.get(i).getTitle();
      if (semester == localSemester && classxyz.equals(localClass) && title.equals(localTitle))
      {
