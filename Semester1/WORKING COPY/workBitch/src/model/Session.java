...
public class Session
{
  ...
  /**
   * A setter for the "weekNumber" variable.
   * @param newNumber the weeknumber to change to.
   */
  ...
  /**
   * A getter for the "weekNumber" variable.
   * @return the value stored in the "weekNumber" instance variable.
   */
  ...
  /**
   * Method checking whether "this" Session is before another given Session.
   *
   * @param other Session object to compare to
   * @return whether "this" Session is before the "other" Session
   */
  ...
  /**
   * A setter for the "classroom" instance variable.
   * @param classroom new classroom for the session
   */
  ...
  public boolean checkForTimeOverlaps(Session other)
  {
    ...
    else if (this.startTime.isBefore(other.endTime) && other.startTime.isBefore(this.endTime))
    {
      return true;
    }
