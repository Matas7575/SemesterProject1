...
public class RescheduleSessPopUpController
{
  ...
  public void displayAvailableClassrooms()
  {
    if (numberChoice.getSelectionModel().getSelectedItem() != null && startChoice.getValue() != null && dateSelect.getValue() != null)
    {
      ...
      availableClassrooms = model.returnAvailableClassrooms(chosenDate,
          new MyTime(hour, minutes), chosenNumLessons);

      ObservableList<Classroom> availableClassroomsShow = FXCollections.observableArrayList(
          availableClassrooms);
