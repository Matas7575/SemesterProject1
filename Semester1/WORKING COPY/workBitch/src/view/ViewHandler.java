...
public class ViewHandler {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle("Ricardo's apprentices");
    ...
    public void openView(String id) {
        ...
        switch (id) {
            ...
            case "Add" : {
                secondaryRoot = AddStudents("AddStudent.fxml");
                ...
                secondaryStage.setTitle("Poopoo windows");
    ...
    private Region AddStudents(String fxmlfile) {
