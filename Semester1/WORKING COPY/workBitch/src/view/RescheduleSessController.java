...
public class RescheduleSessController {
    ...
    @FXML private void cancelSessionPressed() {
        ...
        cancelThis.getClassroom().unbookClassroom(sessionDate,startTime,numLessons);
    ...
    public void initTable(int semester, String classxyz, int week)
    {
        ...
        CourseList thisClassCourseList = model.getAllCourseLists()
            .getCourseListByClass(semester, classxyz);
        ...
        weekdayColumn.setCellValueFactory(
            new PropertyValueFactory<Session, MyDate>("dayOfTheWeek"));
        startTimeColumn.setCellValueFactory(
            new PropertyValueFactory<Session, MyDate>("startTime"));
        endTimeColumn.setCellValueFactory(
            new PropertyValueFactory<Session, MyDate>("endTime"));
        courseColumn.setCellValueFactory(
            new PropertyValueFactory<Session, MyDate>("courseTitle"));
